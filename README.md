...
![here]https://watch.screencastify.com/v/v8nqpZJnwIJM69sYlFSb

GET routes to return all categories, all products
![here](https://watch.screencastify.com/v/qcZc1GU533ejEPPeARBs)

GET routes to return a single category, a single product, and a single tag
![here](https://watch.screencastify.com/v/M4LCsjWd7ypLFmns1zPh)

POST routes to return all categories, all products
![here](https://watch.screencastify.com/v/r2T3iROD067LuEHC8Bsb)

PUT routes to return all categories, all products
![here](https://watch.screencastify.com/v/q0y5v5MM6m8Ab9AtHysg)

DELETE routes to return all categories, all products
![here](https://watch.screencastify.com/v/Ixg42f86motxpAP2HBFN)
